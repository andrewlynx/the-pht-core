...
class The_Photo_Core_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in The_Photo_Core_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The The_Photo_Core_Loader will then create the relationship
	...
	public function enqueue_scripts() {
		...
		wp_register_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/the-photo-core-admin.js', array( 'jquery' ), $this->version, false );
